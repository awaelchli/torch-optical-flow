    ...
    def train_dataloader(self):
        ...
        if self.stage == 'chairs':
            ...
            if TRAIN_DS == 'C+T+K+S+H':
                kitti = KITTI({'crop_size': self.image_size, 'min_scale': -0.3, 'max_scale': 0.5, 'do_flip': True})
                hd1k = HD1K({'crop_size': self.image_size, 'min_scale': -0.5, 'max_scale': 0.2, 'do_flip': True})
