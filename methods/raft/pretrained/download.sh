...
wget https://torch-optical-flow.s3.eu-central-1.amazonaws.com/checkpoints/raft/sintel-epoch%3D2-step%3D119999.ckpt -O checkpoints/raft-sintel.ckpt
wget https://torch-optical-flow.s3.eu-central-1.amazonaws.com/checkpoints/raft/kitti-epoch%3D1249-step%3D49999.ckpt -O checkpoints/raft-kitti.ckpt
